...
public class WebDriverPool {
    ...
    private static final String PHANTOMJS_PATH = "C:\\software\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe";
        ...
        if (refCount.get() < CAPACITY) {
            synchronized (innerQueue) {
                if (refCount.get() < CAPACITY) {
                    ...
                    // mDriver.manage().window().setSize(new Dimension(1366,768));
